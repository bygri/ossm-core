...
class ClubTests: XCTestCase {
  ...
  func testAddClub() {
    ...
    do {
      ...
      let club = try Club.create(forUser: user, inLocation: location, withName: "Sports Group", badgeRecipe: "", primaryColour: "FF0000", secondaryColour: "00FF00", tertiaryColour: "0000FF")
